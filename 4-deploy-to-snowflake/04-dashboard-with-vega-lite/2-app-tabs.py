...
sel = st.sidebar.selectbox("Select chart type", [
    "Deposits By Size of Bank",
    "Share of Total Commercial Bank Deposits, Small Banks (Non-Top 25)",
    "Deposit Flows by Size of Bank, WoW",
    "Monthly Change in Bank Branches Since Covid-19",
    "As of Dec '23: Banks w/ $10B Assets with Lowest FDIC Insured Deposits",
    "Bank Failures by Quarter",
    "Banking Industry Net Interest Income vs. Fed Funds Rate",
    "Interest Expense / Interest Income Ratio vs. Fed Funds Rate"])
...
def format_sql(sql): return sql.replace("\n        ", "\n")
...
if sel == "Deposits By Size of Bank":
    sql, data = deposits_by_size_of_bank_chart()

elif sel == "Share of Total Commercial Bank Deposits, Small Banks (Non-Top 25)":
    sql, data = commercial_bank_deposits_chart()

elif sel == "Deposit Flows by Size of Bank, WoW":
    min_year = 1980
    ...
    sql, data = deposits_flows_chart()

elif sel == "Monthly Change in Bank Branches Since Covid-19":
    sql, data = monthly_change_in_bank_branches_chart()

elif sel == "As of Dec '23: Banks w/ $10B Assets with Lowest FDIC Insured Deposits":
    sql, data = banks_with_lowest_insured_deposits_chart()

elif sel == "Bank Failures by Quarter":
    sql, data = bank_failures_chart()

elif sel == "Banking Industry Net Interest Income vs. Fed Funds Rate":
    sql, data = net_interest_income_vs_fed_funds_rate_chart()

elif sel == "Interest Expense / Interest Income Ratio vs. Fed Funds Rate":
    sql, data = interest_expense_over_interest_income_ratio_vs_fed_funds_rate_chart()
